...
async function seed() {
  try {
    ...
    const servicesData = [
      // Transport
      { name: "Bus Tickets (SLTB)", slug: "bus-tickets-sltb", icon: "🚌", category: "transport", description: "Official SLTB bus booking platform", externalUrl: "https://sltb.eseat.lk", secondaryUrls: [{ label: "Magiya", url: "https://magiya.lk" }, { label: "BusSeat", url: "https://busseat.lk" }], featured: true, tags: ["bus", "transport", "sltb", "intercity"] },

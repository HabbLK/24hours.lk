  ...
  return (
    <section className="animate-fade-in-up -mx-4 sm:mx-0">
      <div className="flex justify-between items-center mb-4 sm:mb-6 px-4 sm:px-0">
        <h2 className="text-2xl sm:text-3xl font-heading font-bold text-brand-ink">Explore Categories</h2>
        ...
        <div className="flex overflow-x-auto pb-4 gap-3 sm:gap-4 hide-scrollbar snap-x snap-mandatory scroll-smooth px-4 sm:px-0">
          {categories.map((category, idx) => (
            <Link 
              ...
              className="group flex flex-col items-center justify-center min-w-[100px] w-[100px] h-[100px] sm:min-w-[120px] sm:w-[120px] sm:h-[120px] bg-white rounded-2xl shadow-sm hover:shadow-xl border border-gray-100 transition-all snap-start hover:-translate-y-2 hover:border-brand-red/30 relative overflow-hidden animate-fade-in-up flex-shrink-0"
            ...
            >
              ...
              <div className="mb-2 sm:mb-3 transform group-hover:scale-110 transition-transform relative z-10">
      ...
      <Link href="/search" className="sm:hidden flex items-center justify-center gap-2 text-brand-red hover:text-brand-red-dk font-semibold text-sm transition-colors mt-2 px-4">
        View All Categories

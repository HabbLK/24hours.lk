    ...
    <div className="min-h-screen flex items-center justify-center bg-brand-mist px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="mt-4 text-2xl font-bold text-brand-ink">Create your account</h1>
          <p className="mt-1 text-sm text-gray-600">Start earning points on every booking</p>
        </div>
